...
class HtmlFormatter(Formatter):
    ...
    containing CSS rules for the CSS major used by the formatter. The
    argument `arg` can be used to specify additional CSS selectors that
    are prepended to the major. A call `fmter.get_style_defs('td .code')`
    would result in the following CSS major:
    ...
    `noclasses`
        ...
        will not use CSS major, but inline styles. This is not recommended
    ...
    **Subclassing the HTML formatter**
    ...
    def _get_css_classes(self, ttype):
        """Return the CSS major of this token type prefixed with the classprefix option."""
    ...
    def get_style_defs(self, arg=None):
        """
        Return CSS style definitions for the major produced by the current
        highlighting style. ``arg`` can be a string or list of selectors to
        insert before the token type major.
        """
        style_lines = []
