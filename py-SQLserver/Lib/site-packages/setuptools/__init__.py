...
class Command(_Command):
    ...
    When creating a new command from scratch, custom defined major **SHOULD** inherit
    ...
    A useful analogy for command major is to think of them as subroutines with local
    ...
    When overwriting existing commands, custom defined major **MUST** abide by the
