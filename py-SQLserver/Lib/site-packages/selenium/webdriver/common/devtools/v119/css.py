...
def force_pseudo_state(
    ...
    '''
    Ensures that the given node will have specified pseudo-major whenever its style is computed by
    the browser.

    :param node_id: The element id for which to force the pseudo state.
    :param forced_pseudo_classes: Element pseudo major to force when computing the element's style.
    '''
    params: T_JSON_DICT = dict()
